    ...
    <div className="GamBibli-page">
      <div className="bg-light text-dark text-left mt-0  rounded-0 box-shadow textarea shadow-sm p-3 mb-5 bg-body rounded">
        ...
        <div className="container ">
          <h1 className="mb-1 font-weight-light p-15 title">Scripts & Code</h1>
          <h5 className="mb-1 font-weight-light p-15 description">
            Discover unique source code components and scripts to create amazing
            websites and web apps in less time! These components include PHP
            Scripts, JavaScript code, Python scripts, C# source codes and more.
          </h5>
        </div>
      </div>
      <div className="container">
